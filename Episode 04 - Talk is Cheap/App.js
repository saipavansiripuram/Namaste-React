  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://i.ibb.co/VwbcG5B/Lovepik-com-401724513-food-logo.png"
          alt="logo"
        />
      </div>
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
       ...
       {/* Looping through the resdata */}

       {
        resList.map((restau)=>(<ReastaurantCard key={restau.info.id} resData={restau }/>))
       }
